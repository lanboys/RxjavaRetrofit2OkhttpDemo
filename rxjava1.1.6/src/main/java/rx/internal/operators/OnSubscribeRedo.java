...
public final class OnSubscribeRedo<T> implements OnSubscribe<T> {
    ...
    public void call(final Subscriber<? super T> child) {
        ...
        Operator<Notification<?>, Notification<?>> operator = new Operator<Notification<?>, Notification<?>>() {
            @Override
        ...
        Observable<Notification<?>> lift = terminals.lift(operator);
        final Observable<?> restarts = controlHandlerFunction.call(lift);
