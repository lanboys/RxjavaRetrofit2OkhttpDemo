...
import com.tamic.retrofitclient.net.ExceptionHandle.ResponseThrowable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RetrofitClient.getInstance(MainActivity.this).createBaseApi()
        ...
        btn_myApi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyApiService service = RetrofitClient
                        .getInstance(MainActivity.this, "http://ip.taobao.com/")
                        .create(MyApiService.class);

                // execute and add observable
                RetrofitClient.getInstance(MainActivity.this).execute(
                        service.getData("21.22.11.33"),
                        new BaseSubscriber<BaseResponse<IpResult>>(MainActivity.this) {
